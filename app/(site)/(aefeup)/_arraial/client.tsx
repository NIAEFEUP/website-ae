          ...
          <div className="space-y-4">
            <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
              <div className="animate_top mx-auto text-center">
                <SectionHeader title="Mapa em Tempo Real" />
              </div>
            </div>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className={`flex items-center gap-2 w-full text-left p-2 rounded transition-colors ${selectedBusId === 'FESTIVAL'
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 w-full text-left p-2 rounded transition-colors ${selectedBusId === 'HSJ'
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 w-full text-left p-2 rounded transition-colors ${selectedBusId === 'EXP'
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 w-full text-left p-2 rounded transition-colors ${selectedBusId === 'BXP'
