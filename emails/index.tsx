...
export const EmailTemplate = ({
  ...
  requestEventInfo: EventRequestInfo;
}) => (
  <Html>
    <Head />
    <Preview>
              ...
              <Section>
                ...
                <Row>
                  <Column style={informationTableColumn}>
                    ...
                    <Text style={informationTableValue}>
                      {requestEventInfo.responsible_name}
                    </Text>
                  </Column>
                </Row>
                <Row>
                ...
                <Row>
                  <Column style={informationTableColumn}>
                    ...
                    <Text style={informationTableValue}>
                      {requestEventInfo.contact_number}
                    </Text>
                  </Column>
                </Row>
                {requestEventInfo.isEvent ? (
                  <div>
                    ...
                    <Row>
                      <Column style={informationTableColumn}>
                        ...
                        <Text style={informationTableValue}>
                          {requestEventInfo.event_description}
                        </Text>
                      </Column>
                    </Row>
                  </div>
...
export const OrderConfirmationEmailTemplate = (order: Order) => (
  <Html>
    <Head />
    <Preview>{`Confirmação de Pedido: ${order.id}`}</Preview>
    ...
    <Body style={main}>
      <Container style={container}>
        <Section>
          <Row>
            <Column style={tableCell}>
              <Text style={heading}>Confirmação de Pedido</Text>
            </Column>
          </Row>
        </Section>
        <Section>
          <Text style={cupomText}>{`Olá,`}</Text>
          <Text style={cupomText}>
            {`Seu pedido número ${order.id} foi confirmado.`}
          </Text>
        </Section>
        <Section style={informationTable}>
          <Row style={informationTableRow}>
            <Column colSpan={2}>
              <Section>
                <Row>
                  <Column style={informationTableColumn}>
                    <Text style={informationTableLabel}>Número do Pedido</Text>
