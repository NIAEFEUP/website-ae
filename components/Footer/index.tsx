  ...
  return (
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-12">
          {/* <!-- Footer Top --> */}
          <div className="py-10 ">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              <div className="flex w-full flex-col gap-8 md:flex-row justify-between">
                <div className="animate_top">
                  ...
                  >
                    ...
                    <p>
                      Rua Doutor Júlio de Matos, 882
                    </p>
                    <p className="mb-10">
                      4200–356 Paranhos, Porto
                    </p>
                  </motion.div>
                </div>
                <div className="animate_top">
                ...
                <div className="animate_top">
                  ...
                  >
                    ...
                    <p className="">
                      <a href="tel:+351225081556">+351 225 081 556</a>
                    </p>
                    <p className="mb-4">
                      <a href="mailto:geral@aefeup.pt">
                        geral@aefeup.pt
                      </a>
                    </p>
                    {/* 
