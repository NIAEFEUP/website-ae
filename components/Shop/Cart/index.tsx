...
const ShopCart = ({ isOpen, onOpenChange, products, removeFromCart }: ShopCartProps) => {
   ...
   const [paymentStatusState, setPaymentStatus] = React.useState<paymentStatus>(paymentStatus.waiting)
   ...
   return <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="z-100000 flex flex-col justify-between">
         ...
         <SheetFooter className="!flex !flex-col">
            ...
            {!processingPayment ? <PaymentForm setNumber={setNumber} products={products} setProcessingPayment={setProcessingPayment} setPaymentStatus={setPaymentStatus}></PaymentForm> :
