...
const PaymentForm = ({ setNumber, products, setProcessingPayment, setPaymentStatus }: PaymentFormProps) => {

   return (
      <>
         <div className="flex flex-col w-full gap-5">
            <div className="flex gap-2">
               <Card className={"cursor-pointer w-25 h-20 border-blue-500"} onClick={() => { }}>
                  <CardHeader>
            ...
            <div className="min-h-30 flex">
               <div className="flex w-full max-w-sm items-center space-x-2 justify-between self-center" >
                  ...
                  <Button type="submit" className="self-end" onClick={() => { setPaymentStatus(paymentStatus.confirmed); setProcessingPayment(true) }}> Pay </Button>
               </div>
            </div>
         </div>
      </>)
